            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () =>
                        Navigator.pushNamed(context, '/leave-room'),
                    child: Container(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: msg.isPlaying ? AppColors.primary : Colors.transparent,
                ...
                child: Icon(
                  ...
                  color:
                      msg.isPlaying ? Colors.white : AppColors.textSecondary,
                  size: 20,
                ),
              ),
              const SizedBox(width: 10),
    ...
    return Row(
      ...
      children: heights
          .map((h) => Container(
                ...
                decoration: BoxDecoration(
                  color:
                      active ? AppColors.primary : const Color(0xFFBBBBBB),
